...
export default function SearchBar({ handleSearchBarToggle, }) {
    ...
    dir="ltr">
      ...
      <input placeholder={translate({
        ...
        })} aria-label="Search" className={`navbar__search-input ${styles.searchInput}`} onFocus={onInputFocus} onBlur={onInputBlur} onChange={onInputChange} ref={searchBarRef} value={inputValue}/>
